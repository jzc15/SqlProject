...
CREATE TABLE books (title VARCHAR(200), weight INT(20), student_id INT(10), FOREIGN KEY(student_id) REFERENCES students(id));
SHOW TABLES;
...
DELETE FROM students WHERE id = 7 AND name = 'King';

UPDATE students SET age = 20 WHERE id = 0 AND name = 'Alice';
